...
Ребята из [Zapret GUI](https://github.com/youtubediscord/zapret) — большие молодцы, я к ним не придираюсь.

А свой код я сделал просто так, для прикола — чтобы друзьям похвастаться: «Смотри, что я могу!». Это не конкурентный продукт.
